...
export default function Register() {
  ...
  return (
    <>
      <Head>
        <title>Registrarse - LimaSTEM</title>
        <meta name="description" content="Crea tu cuenta en LimaSTEM" />
      </Head>

      <div className="min-h-screen w-full flex items-center justify-center p-4 relative overflow-hidden bg-[#0b011d]">
        {/* Background Elements */}
        <div className="absolute inset-0 hero-grid opacity-20 pointer-events-none" />
        <div className="absolute top-0 right-1/4 w-96 h-96 bg-primary-600/20 rounded-full blur-[128px] pointer-events-none" />
          ...
          >
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-gray-400 text-sm">
                Empieza tu viaje en el mundo STEM hoy mismo
              </p>
            </div>
          </motion.div>
