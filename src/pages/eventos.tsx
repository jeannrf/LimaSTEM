...
import { Calendar, MapPin, Search, Filter, Loader2, Sparkles } from 'lucide-react';
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto text-lg">
              Conferencias, talleres y meetups seleccionados para impulsar tu carrera tecnológica en Lima.
            </p>
          </div>
          ...
          {!loading && filteredEvents.length === 0 && (
            <div className="text-center py-20 opacity-50">
              <p className="text-xl text-white">No se encontraron eventos en esta categoría.</p>
            </div>
          )}
        </div>
      </div>
