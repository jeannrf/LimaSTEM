...
import { Calendar, MapPin, Clock, Search, Filter, Loader2, Sparkles, Bell, Ticket, ChevronDown, X, ExternalLink, ArrowUpRight } from 'lucide-react';
...
interface Event {
  ...
  external_link?: string; // Support both for now to avoid breaking changes
}
            ...
            {filteredEvents.map((event, index) => (
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow relative">
                  ...
                  <div className="space-y-3 pt-4 border-t border-white/5 z-10">
                    ...
                    <div className="flex items-center gap-3 text-slate-300 text-sm">
                      <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center shrink-0">
                        <Clock size={14} className="text-[#9d4edd]" />
                      </div>
                      <span>
              ...
              >
                ...
                <div className="p-6 overflow-y-auto custom-scrollbar">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                    ...
                    <div className="flex items-center gap-3 p-4 rounded-2xl bg-[#130725] border border-white/5">
                      ...
                      <div>
                        ...
                        <p className="text-white font-medium">
                          {new Date(selectedEvent.date).toLocaleTimeString('es-PE', {
                            hour: '2-digit', minute: '2-digit', hour12: true
                          })}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 p-4 rounded-2xl bg-[#130725] border border-white/5 sm:col-span-2">
                      <div className="w-10 h-10 rounded-full bg-[#9d4edd]/10 flex items-center justify-center text-[#9d4edd]">
                        <MapPin size={20} />
                      </div>
                      <div>
                  ...
                  <div className="sticky bottom-0 pt-4 bg-[#1e142b] border-t border-white/5 mt-auto">
                    <button
                      onClick={() => window.open(selectedEvent.registration_link || selectedEvent.external_link || 'https://www.linkedin.com/search/results/all/?keywords=' + encodeURIComponent(selectedEvent.title), '_blank')}
